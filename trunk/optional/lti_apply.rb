...
[],
["GenericVector<double >", "GenericVector<double >"],
["double (*)(double,double)"],
]
...
[],
["GenericVector<float >", "GenericVector<float >"],
["float (*)(float,float)"],
]
...
[],
["GenericVector<int >", "GenericVector<int >"],
["int (*)(int,int)"],
]
...
[],
["GenericVector<unsigned char >", "GenericVector<unsigned char >"],
["unsigned char (*)(unsigned char,unsigned char)"],
]
...
[],
["Array<unsigned char >", "Array<unsigned char >"],
["unsigned char (*)(unsigned char,unsigned char)"],
]
...
["Channel"],
["std::list<lti::vector<float > >"],
["Channel", "Channel"],
["std::list<lti::vector<float > >"],
["TpointList<int >", "Channel"],
["std::list<lti::vector<float > >"],
]
...
ImaskFunctor.form = [
["Matrix<int >", "int (*)(int const &,int const &)"],
["Matrix<int >"],
["int (*)(int const &,int const &)"],
["Matrix<int >"],
["Matrix<int >", "Matrix<int >", "int (*)(int const &,int const &,int const &)"],
["Matrix<int >"],
["Matrix<int >", "int (*)(int const &,int const &,int const &)"],
["Matrix<int >"],
...
["Palette"],
["Image", "Channel8"],
["Palette", "Vector<lti::trgbPixel<float > >"],
["Image", "Matrix<int >"],
["Palette", "Vector<lti::trgbPixel<float > >"],
["Image", "Matrix<int >"],
["Vector<lti::trgbPixel<float > >", "Ivector", "int"],
["Image", "Matrix<int >"],
["Vector<lti::trgbPixel<float > >", "Ivector"],
["Image", "Channel8"],
["Palette", "Vector<lti::trgbPixel<float > >", "Vector<int >"],
["Image", "Matrix<int >"],
["Palette", "Vector<lti::trgbPixel<float > >", "Vector<int >"],
["Image", "Matrix<int >"],
["Vector<lti::trgbPixel<float > >", "std::vector<lti::matrix<float > >", "Vector<int >"],
["Channel", "Channel", "Channel", "Matrix<int >"],
["Vector<lti::trgbPixel<float > >", "std::vector<lti::matrix<float > >", "Vector<int >"],
["Channel", "Channel", "Channel", "Matrix<int >"],
["Vector<lti::trgbPixel<float > >", "Vector<int >"],
["Channel", "Matrix<int >"],
["Vector<float >", "Vector<float >", "Vector<int >"],
["Image", "Matrix<int >"],
["int", "TrgbPixel<float >", "Matrix<float >", "int"],
]
...
["Matrix<int >"],
["Image"],
["Matrix<lti::ubyte >", "Palette"],
["Image"],
["Matrix<int >", "Palette"],
["Image"],
["Matrix<lti::ubyte >", "Vector<float >"],
["Fmatrix"],
["Matrix<int >", "Vector<float >"],
["Fmatrix"],
["Image"],
["Matrix<lti::ubyte >"],
["Image"],
...
["Image", "principalComponents<float >"],
["Imatrix"],
["Image", "DrgbPixel", "Dmatrix"],
["Imatrix"],
]
...
["Channel8"],
["Channel8"],
["Channel8", "float", "float", "bool", "bool"],
["Channel8"],
["Channel8", "float", "float", "bool"],
["Channel8"],
["Channel8", "float", "float"],
["Channel8"],
["Channel8", "float"],
[],
["Channel"],
...
["Channel"],
["Channel"],
["Channel", "float", "float", "bool", "bool", "float", "float"],
["Channel"],
["Channel", "float", "float", "bool", "bool", "float"],
["Channel"],
["Channel", "float", "float", "bool", "bool"],
["Channel"],
...
["Image", "Imatrix"],
["int", "Dmatrix", "Dmatrix"],
["Image", "std::list<lti::areaPoints >"],
["Dmatrix", "Dmatrix", "Imatrix"],
]
...
["Imatrix", "Ivector"],
["Channel8"],
["Channel8", "Ivector", "std::vector<lti::areaPoints >"],
["Channel8"],
["Imatrix", "Ivector", "std::vector<lti::areaPoints >"],
["Imatrix"],
["Imatrix", "Ivector", "std::vector<lti::areaPoints >"],
["Channel8"],
["Channel8", "Ivector", "int"],
["Channel8"],
["Imatrix", "Ivector", "int"],
["Imatrix"],
["Imatrix", "Ivector", "int"],
...
["Channel8"],
["std::list<lti::ioPoints >"],
["Matrix<int >"],
["std::list<lti::ioPoints >"],
["Channel8"],
["std::list<lti::borderPoints >"],
["Imatrix"],
["std::list<lti::borderPoints >"],
["Channel8"],
["std::list<lti::areaPoints >"],
["Matrix<int >"],
["std::list<lti::areaPoints >"],
["Channel8"],
["std::list<lti::areaPoints >", "Matrix<int >"],
["Matrix<int >"],
["std::list<lti::areaPoints >", "Matrix<int >"],
["Channel8"],
["tree<objectStruct >"],
...
["Channel", "std::list<lti::location >"],
["std::list<lti::dvector >"],
["Channel8", "std::list<lti::location >"],
["std::list<lti::dvector >"],
["std::list<lti::channel >", "std::list<lti::location >"],
["std::list<lti::dvector >"],
["Image", "std::list<lti::location >"],
["std::list<lti::dvector >"],
["Image", "Location"],
["Dvector"],
["Channel", "Location"],
...
["Channel8"],
["std::vector<lti::rectangle >"],
["Channel8"],
["Imatrix", "std::vector<lti::rectangle >"],
["Channel8"],
["std::vector<geometricFeatureGroup0 >"],
["Channel8"],
["Imatrix", "std::vector<geometricFeatureGroup0 >"],
]

MultiGeometricFeaturesFromMask.form = [
["Channel8"],
["std::vector<std::vector<lti::rectangle > >"],
["Channel8"],
["Imatrix", "std::vector<std::vector<lti::rectangle > >"],
["Channel8"],
["std::vector<std::vector<geometricFeatureGroup0 > >"],
["Channel8"],
["Imatrix", "std::vector<std::vector<geometricFeatureGroup0 > >"],
]
...
["PolygonPoints"],
["TpointList<float >"],
["TpolygonPoints<float >"],
["TpointList<double >"],
["TpolygonPoints<double >"],
]

Rclassifier.form = [
["Dvector"],
["Classifier_outputVector"],
]
