...
[In[Rblti::Channel8], Out[Rblti::Channel8], Out[Rblti::Ivector], Out[Rblti::Vector_areaPoints]],
[In[Rblti::Channel8], Out[Rblti::Imatrix], Out[Rblti::Ivector], Out[Rblti::Vector_areaPoints]],
[In[Rblti::Imatrix], Out[Rblti::Imatrix], Out[Rblti::Ivector], Out[Rblti::Vector_areaPoints]],
...
KalmanFilter.forms = [
[In[Rblti::Fvector]],
[In[Rblti::Fvector], In[Rblti::Fvector]],
[],
[In[Rblti::Fvector]],
[In[Rblti::Fvector]],
[],
...
begin
KalmanTracker.forms = [
[In[Rblti::Float], In[Rblti::Float], Out[Rblti::Float], Out[Rblti::Float]],
[Out[Rblti::Float], Out[Rblti::Float]],
]; rescue Exception=>e; GridFlow.post "form error: %s", e.inspect end
