...
class RharrisCorners_parameters : public lti::_cornerDetector::RcornerDetector_parameters
{
public:
    ...
    localMaxima_parameters localMaximaParameters  ;
    gradientFunctor_parameters gradientFunctorParameters  ;
};
}
